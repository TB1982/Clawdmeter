...
| 3 | magnifier | 43 | 9,410 ms | 2.13 |
| 4 | rainy days | 18 | 2,700 ms | 7.41 |
| 5 | lurking | 24 | 4,330 ms | 4.62 |
...
A ✓ means the loop divides the slot exactly, so it is never cut part-way. 6 of 24 do: hanabi, space, crab walking, work mode, dancing, this is fine.
